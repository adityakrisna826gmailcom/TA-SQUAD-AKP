...
Feature: Form Return Sales Show Page
...
#Show Page 50   
    ...
    #Scenario: Siloam090 Form Return Sales Show Page Lima Puluh
#		When Siloam090 Sales Sudah Login Dan Berada Di Halaman Form Return Show Page Lima Puluh
#		And  Siloam090 Sales Tekan Tombol Show Lima Puluh
#		And  Siloam090 Sales Pilih Lima Puluh
    #Then Siloam090 Validasi Angka Lima Puluh
    #
   #Scenario: Siloam090 Form Return Sales Show Page Lima Puluh Next
#		When Siloam090 Sales Sudah Login Berada Di Halaman Form Return Dan Pilih Show Page Lima Puluh
#		And  Siloam090 Sales Tekan Tombol Show Lima Puluh Next
    #Then Siloam090 Validasi Angka Lima Puluh Satu 
    #
    #Scenario: Siloam090 Form Return Sales Show Page Lima Puluh Previous
#		When Siloam090 Sales Sudah Login Berada Di Halaman Form Return Pilih Show Page Lima Puluh Dan Next 
#		And  Siloam090 Sales Tekan Tombol Show Lima Puluh Previous
    #Then Siloam090 Validasi Angka Lima Puluh Previous    


#Show Page 100  

    Scenario: Siloam090 Form Return Sales Show Page Seratus
   ...
   Scenario: Siloam090 Form Return Sales Show Page Seratus Next
    ...
    Scenario: Siloam090 Form Return Sales Show Page Seratus Previous
